...
sample_filenames = [i for i in glob.glob('../data/scrublet-scores/sample*.{}'.format('csv'))]
...
#export to csv
scrublet_merged.to_csv( "../data/scrublet-scores/scrublet_scores.csv", index=False, encoding='utf-8-sig')

...
def export_cmat_tsv(fileID):
    adata_path = 'data/brain-development_'+fileID+'.h5ad'
...
docker run -it --rm \
    ...
    aertslab/pyscenic:0.10.2 pyscenic grn \
        --num_workers 7 \
        -o /scenicdata/brain-development/data/scenic/cmat_adjacencies_${fileID}.csv.gz \
...
docker run -it --rm \
    ...
    aertslab/pyscenic:0.10.2 pyscenic ctx \
        /scenicdata/brain-development/data/scenic/cmat_adjacencies_${fileID}.csv.gz \
